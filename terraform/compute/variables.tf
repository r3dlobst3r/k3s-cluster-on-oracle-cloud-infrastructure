...
locals {
  server_instance_config = {
    ...
    source_id   = "ocid1.image.oc1.phx.aaaaaaaa2jgxxuh2chaw433maugvevyzpqhdlzyglqn4zakzs7zflf3lkr7a"
    source_type = "image"
  ...
  worker_instance_config = {
    ...
    ram      = 1
    // Canonical-Ubuntu-20.04-aarch64-2021.12.01-0
    source_id   = "ocid1.image.oc1.phx.aaaaaaaa4tturmj4on4b23hiua2lnos7lczwfmdim2oosm77cjlywhbudctq"
    source_type = "image"
